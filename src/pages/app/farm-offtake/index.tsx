...
const FarmOffTakes = () => {
  ...
  async function fetchProducts() {
    const productsCollectionRef = collection(db, 'farmofftake');
  ...
  return (
    <div className='container flex h-full w-full max-w-[180.75rem] flex-col gap-6  overflow-auto px-container-md pb-[2.1rem]'>
      <div className='flex justify-between '>
        <div>
          <h3 className='mb-4 text-base font-semibold md:text-2xl'>Farm Off-Take</h3>
          <p className='text-[0.85rem] '>All farm off-Take you have added will appear here</p>
        </div>
        <div>
      ...
      <Link
        ...
        to={`/app/${CONSTANTS.ROUTES['create-farm-offtake']}`}
